...
/proc/flash_color(mob_or_client, flash_color = COLOR_CULT_RED, flash_duration = 20)
	var/mob/flashed_mob
	...
	temp_color.fade_in = flash_duration * 0.25
	temp_color.fade_out = flash_duration * 0.25
	QDEL_IN(temp_color, (flash_duration * 0.5) + 1)
