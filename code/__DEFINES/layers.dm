...
/// Keep this above OPEN_DOOR_LAYER, special layer used for /obj/effect/mapping_helpers/airlock/access
#define DOOR_ACCESS_HELPER_LAYER 2.71
/// Keep this above DOOR_ACCESS_HELPER_LAYER and OPEN_DOOR_LAYER since the others tend to have tiny sprites that tend to be covered up.
#define DOOR_HELPER_LAYER 2.72
/// Projectiles won't hit objects at or below this layer if possible
